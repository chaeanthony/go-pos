...
curl -X PUT http://localhost:8091/api/items \
  ...
  -d '{"id":"0196de5f-3733-4be1-93e3-f1cc5e722101","name":"Espresso","description":"Black espresso. Chocolate with hint of plum","cost":12.00}'
